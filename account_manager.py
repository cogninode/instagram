...
class AccountManager:
    ...
    def get_account_for_task(self):
        ...
        if not self.current_account:
            ...
            self.tasks_with_current = 0
            print(f"✅ Selected and activated account: {self.current_account['username']}")
    ...
    def mark_account_error(self, account_id, error_type='error'):
        ...
        print(f"Account error detected. Setting cooldown.")
    ...
    def add_account(self, username, password):
        ...
        return self.db.add_account(username, password)
