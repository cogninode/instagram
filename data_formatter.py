...
#                 'caption_preview': post.get('captionpreview', ''),
...
#                 'profile_url': follower.get('profileurl', ''),
...
#                 'full_name': comment.get('owner', {}).get('full_name', '') if isinstance(comment.get('owner'), dict) else '',
#                 'comment_text': comment.get('text', '') or comment.get('comment', ''),
#                 'likes_count': comment.get('likesCount', 0) or comment.get('likes', 0),
#                 'replies_count': comment.get('repliesCount', 0),
#                 'timestamp': comment.get('timestamp', ''),
#                 'comment_id': comment.get('id', ''),
#                 'comment_url': comment.get('commentUrl', ''),
#                 'post_url': comment.get('postUrl', ''),
#                 'is_verified': comment.get('owner', {}).get('is_verified', False) if isinstance(comment.get('owner'), dict) else False,
#                 'profile_pic_url': comment.get('ownerProfilePicUrl', '') or comment.get('profile_pic_url', ''),
#                 'user_id': comment.get('owner', {}).get('id', '') if isinstance(comment.get('owner'), dict) else '',
...
#             ],
#             'comments': [
#                 'comment_number', 'username', 'full_name', 'comment_text',
#                 'likes_count', 'replies_count', 'timestamp', 'is_verified',
#                 'comment_id', 'comment_url', 'post_url', 'user_id',
#                 'profile_pic_url', 'scraped_at'
#             ],
#             'likes': [
#                 'index', 'username', 'full_name', 'profile_url', 'profile_pic_url',
#                 'is_verified', 'is_private', 'scraped_at'
